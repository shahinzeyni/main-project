    ...
    <div class="comments">
      ...
      {authContext.isLoggedIn === true ? (
        <>
          ...
          <div class="comments__respond">
            ...
            <div class="comments__respond-content">
              ...
              <textarea class="comments__score-input-respond" onChange={(e) => setTextAreaValue(e.target.value)}>

              </textarea>
            </div>
            <button type="submit" onClick={() => onSubmitComment(textAreaValue)} class="comments__respond-btn">
              ارسال
            </button>
          </div>
        </>
        ...
        <div className="alert alert-danger ">
          برای ثبت کامنت ابتدا <Link to="/login">لاگین</Link> کنید    
        </div>
      )}
    </div>
  );
